...
class Booking(db.Model):
    ...
    event = db.relationship('Event', back_populates='bookings')  # 🔥 FIXED
    user = db.relationship('User', back_populates='bookings')    # 🔥 FIXED
...
class Event(db.Model):
    ...
    bookings = db.relationship("Booking", back_populates="event")  # 🔥 FIXED
